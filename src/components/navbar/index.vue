<template>
    <div class="navbar">
        <div class="left-side">
            <TabBar v-if="appStore.tabBar" :style="appStore.hideMenu?'width: 100%;padding-left: 0px;':appStore.menuCollapse?'width: 100%;padding-left: 48px;':'width: 100%;padding-left: '+appStore.menuWidth+'px;' "/>
        </div>
        <ul class="right-side">
<!--            <li>
...
//     leftWidth.value = clientWidth.value-appStore.menuWidth-200-20
// })
