<template>
  ...
  >
    <template #title>
      <span class="cu-fontWeight700 cu-font16"> {{$t('menu.rescue.statistics.work.title')}} </span>
    </template>
    <a-grid :cols="24" :col-gap="12" :row-gap="12">
      <a-grid-item :span="{ xs: 12, sm: 12, md: 12, lg: 8, xl: 8, xxl: 8 }">
        <a-card :title="$t('menu.rescue.statistics.work.today.title')" :bordered="false" 
          ...
          <template #title>
            <span class="cu-fontWeight700 cu-font14 font-color-FFFFFF"> {{$t('menu.rescue.statistics.work.today.title')}} </span>
          </template>
            ...
            <div class="content">
              <a-space direction="vertical" fill>
                <a-card :body-style="cradBodyStyle" :style="cradStyle" :bordered="false">
                  <div class="cu-fy-between-center-lr">
                    <span class="cu-fy-between-center-lr">
                      ...
                      <a-typography-text class="cu-font12 cu-marl8">{{$t('menu.rescue.statistics.work.notorderNum')}}</a-typography-text>
                    </span>
                    <a-typography-text>
                      <a-statistic :value="unrevNum.dayNum" :value-from="0" :start="true" :value-style="{ fontSize:'14px' }" animation>
                        <template #suffix>
                ...
                <a-card  :body-style="cradBodyStyle" :style="cradStyle" :bordered="false">
                  <div class="cu-fy-between-center-lr">
                    <span class="cu-fy-between-center-lr">
                      ...
                      <a-typography-text class="cu-font12 cu-marl8">{{$t('menu.rescue.statistics.work.orderNum')}}</a-typography-text>
                    </span>
                    <a-typography-text>
                ...
                <a-card  :body-style="cradBodyStyle" :style="cradStyle" :bordered="false">
                  <div class="cu-fy-between-center-lr">
                    <span class="cu-fy-between-center-lr">
                      ...
                      <a-typography-text class="cu-font12 cu-marl8">{{$t('menu.rescue.statistics.work.finishNum')}}</a-typography-text>
                    </span>
                    <a-typography-text>
                ...
                <a-card  :body-style="cradBodyStyle" :style="cradStyle" :bordered="false">
                  <div class="cu-fy-between-center-lr">
                    <span class="cu-fy-between-center-lr">
                      <a-avatar class="avatar cu-bgcolor-7BC0FC-3491FA" :size="24"><a-image :src="peopleNumPic" :preview="false"></a-image></a-avatar>
                      <a-typography-text class="cu-font12 cu-marl8">{{$t('menu.rescue.statistics.work.rescuePeopleNum')}}</a-typography-text>
                    </span>
                    <a-typography-text>
                      <a-statistic :value="resPpl.dayNum" :value-from="0" :start="true" :value-style="{ fontSize:'14px' }" animation>
                        <template #suffix>
                          <span class="cu-font12 cu-fontWeight600">{{$t('menu.rescue.statistics.peo')}}</span>
                        </template>
                      </a-statistic>
                    </a-typography-text>
                  </div>
      ...
      <a-grid-item :span="{ xs: 12, sm: 12, md: 12, lg: 8, xl: 8, xxl: 8 }">
        <a-card :title="$t('menu.rescue.statistics.work.month.title')" :bordered="false" 
        ...
        :body-style="bodyStyle">
          <template #title>
            <span class="cu-fontWeight700 cu-font14 font-color-FFFFFF"> {{$t('menu.rescue.statistics.work.month.title')}} </span>
          </template>
          <div class="content-wrap">
            <div class="content">
              <a-space direction="vertical" fill>
              <a-card  :body-style="cradBodyStyle" :style="cradStyle" :bordered="false">
                <div class="cu-fy-between-center-lr">
                  ...
                  <a-typography-text>
                      <a-statistic :value="unrevNum.monthNum" :value-from="0" :start="true" :value-style="{ fontSize:'14px' }" animation>
                        <template #suffix>
                          <span class="cu-font12 cu-fontWeight600">{{$t('menu.rescue.statistics.single')}}</span>
                        </template>
                      </a-statistic>
              ...
              <a-card  :body-style="cradBodyStyle" :style="cradStyle" :bordered="false">
                <div class="cu-fy-between-center-lr">
                  <span class="cu-fy-between-center-lr">
                    <a-avatar class="avatar cu-bgcolor-4CD263-00B42A" :size="24"><a-image :src="peopleNumPic" :preview="false"></a-image></a-avatar>
                    <a-typography-text class="cu-font12 cu-marl8">{{$t('menu.rescue.statistics.work.rescuePeopleNum')}}</a-typography-text>
                  </span>
                  <a-typography-text>
                    <a-statistic :value="resPpl.monthNum" :value-from="0" :start="true" :value-style="{ fontSize:'14px' }" animation>
                      <template #suffix>
                        <span class="cu-font12 cu-fontWeight600">{{$t('menu.rescue.statistics.peo')}}</span>
                      </template>
                    </a-statistic>
      ...
      <a-grid-item :span="{ xs: 12, sm: 12, md: 12, lg: 8, xl: 8, xxl: 8 }">
        <a-card :title="$t('menu.rescue.statistics.work.year.title')" :bordered="false"
         ...
         :body-style="bodyStyle">
          <template #title>
            <span class="cu-fontWeight700 cu-font14 font-color-FFFFFF"> {{$t('menu.rescue.statistics.work.year.title')}} </span>
          </template>
          <div class="content-wrap">
            <div class="content">
              <a-space direction="vertical" fill>
              <a-card  :body-style="cradBodyStyle" :style="cradStyle" :bordered="false">
                <div  class="cu-fy-between-center-lr">
                  ...
                  <a-typography-text>
                      <a-statistic :value="unrevNum.yearNum" :value-from="0" :start="true" :value-style="{ fontSize:'14px' }" animation>
                        <template #suffix>
                          <span class="cu-font12 cu-fontWeight600">{{$t('menu.rescue.statistics.single')}}</span>
                        </template>
                      </a-statistic>
              ...
              <a-card  :body-style="cradBodyStyle" :style="cradStyle" :bordered="false">
                <div class="cu-fy-between-center-lr">
                  <span class="cu-fy-between-center-lr">
                    <a-avatar class="avatar cu-bgcolor-A871E3-722ED1" :size="24"><a-image :src="peopleNumPic" :preview="false"></a-image></a-avatar>
                    <a-typography-text class="cu-font12 cu-marl8">{{$t('menu.rescue.statistics.work.rescuePeopleNum')}}</a-typography-text>
                  </span>
                  <a-typography-text>
                    <a-statistic :value="resPpl.yearNum" :value-from="0" :start="true" :value-style="{ fontSize:'14px' }" animation>
                      <template #suffix>
                        <span class="cu-font12 cu-fontWeight600">{{$t('menu.rescue.statistics.peo')}}</span>
                      </template>
                    </a-statistic>
...
<script lang="ts" setup>
  ...
  import peopleNumPic from '@/assets/images/rescue/peopleNum.png';
  ...
  // 待接单数量
  const unrevNum: any = ref({})
  // 已接单数量
  const revNum: any = ref({})
  // 已完成数量
  const compNum: any = ref({})
  // 已解救人数
  const resPpl: any = ref({})
  ...
  const eleWorkStat =  async (params) => {
    ...
    const { data } = await getEleWorkStat(objParams);
    unrevNum.value = data.unrevNum
    revNum.value = data.revNum
    compNum.value = data.compNum
    resPpl.value = data.resPpl
  }
  ...
  const cardHeaderStyle = {borderBottom: '0',padding:'20px 0 0 20px',fontWeight: '700',fontSize: '14px',lineHeight: '22px'}
