<template>
    <div class="container cu-flex-y">
        <Breadcrumb :items="['menu.archives', 'menu.archives.elevator', 'menu.archives.view']" />
...
import ElevatorData from './components/ElevatorData.vue';
import IotData from './components/IotData.vue';
import WorkOrder from './components/WorkOrder.vue';
import MaintainOrder from './components/MaintainOrder.vue';
