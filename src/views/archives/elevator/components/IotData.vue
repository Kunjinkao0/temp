<template>
    <div class="cu-padb24">
        <div class="cu-flex cu-padlr24  cu-padb20" style="background:white">
            ...
            <div class="cu-flex1 cu-marl16 videoTab">
                <a-card style="height: 400px; overflow-y: auto">
        ...
        <a-card class="cu-mart16" :header-style="{padding:'20px 20px 10px 20px',border:'0px'}" :body-style="{padding:'20px 20px 10px 20px'}" :title="$t('menu.archives.fault.search')">
            <!-- 搜索部分 -->
            <a-row>
                <a-col :flex="6">
        ...
        <div class="cu-fx-between-center cu-mart16 cu-padlr24 cu-padtop24" style="background:white">
            <div class="tableTab">
        ...
        <a-table row-key="id" :loading="loading" :pagination="pagination" :columns="cloneColumns" :data="renderData" :bordered="false" :stripe="true"
            @page-change="onPageChange" style="background:white" class="cu-padt16 cu-padlr24">
