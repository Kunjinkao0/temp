<template>
    <div class="container cu-flex-y">
        <Breadcrumb :items="['menu.archives', 'menu.archives.elevator']" />
                                    ...
                                    <a-row :gutter="16">
                                        ...
                                        <a-col :span="8" v-if="collapseFlag">
                                            ...
                                            <a-form-item field="useName"
                                                :label="$t('menu.archives.propertyName')" label-col-flex="60px">
                                                <a-input class="input-search" v-model="formModel.propertyName"
                                                    :placeholder="$t('menu.archives.propertyName.placeholder')" allow-clear/>
                                            </a-form-item>
                                        </a-col>
      ...
      <a-modal width="850px" class="maintenantice-ststistics" v-model:visible="detailVisible" :simple="true" unmount-on-close="false"
        ...
        <div>
          <DetailModal :loading="loading" :id="eleId"/>
        </div>
      </a-modal>
    </div>
</template>
