<template>
  ...
  >
    <template #title>
      <span class="cu-fontWeight700 cu-font16"> {{$t('menu.repair.statistics.work.title')}} </span>
    </template>
    <a-grid :cols="24" :col-gap="12" :row-gap="12">
      <a-grid-item :span="{ xs: 12, sm: 12, md: 12, lg: 8, xl: 8, xxl: 8 }">
        <a-card :title="$t('menu.repair.statistics.work.today.title')" :bordered="false" 
          ...
          <template #title>
            <span class="cu-fontWeight700 cu-font14 font-color-FFFFFF"> {{$t('menu.repair.statistics.work.today.title')}} </span>
          </template>
                ...
                <a-card  :body-style="cradBodyStyle" :style="cradStyle" :bordered="false">
                  <div class="cu-fy-between-center-lr">
                    <span class="cu-fy-between-center-lr">
                      ...
                      <a-typography-text class="cu-font12 cu-marl8">{{$t('menu.repair.statistics.work.sendOrderNum')}}</a-typography-text>
                    </span>
                    <a-typography-text>
                ...
                <a-card  :body-style="cradBodyStyle" :style="cradStyle" :bordered="false">
                  <div class="cu-fy-between-center-lr">
                    <span class="cu-fy-between-center-lr">
                      ...
                      <a-typography-text class="cu-font12 cu-marl8">{{$t('menu.repair.statistics.work.orderNum')}}</a-typography-text>
                    </span>
                    <a-typography-text>
                ...
                <a-card  :body-style="cradBodyStyle" :style="cradStyle" :bordered="false">
                  <div class="cu-fy-between-center-lr">
                    <span class="cu-fy-between-center-lr">
                      ...
                      <a-typography-text class="cu-font12 cu-marl8">{{$t('menu.repair.statistics.work.finishNum')}}</a-typography-text>
                    </span>
                    <a-typography-text>
                ...
                <a-card  :body-style="cradBodyStyle" :style="cradStyle" :bordered="false">
                  <div class="cu-fy-between-center-lr">
                    <span class="cu-fy-between-center-lr">
                      ...
                      <a-typography-text class="cu-font12 cu-marl8">{{$t('menu.repair.statistics.work.evaluateNum')}}</a-typography-text>
                    </span>
                    <a-typography-text>
      ...
      <a-grid-item :span="{ xs: 12, sm: 12, md: 12, lg: 8, xl: 8, xxl: 8 }">
        <a-card :title="$t('menu.repair.statistics.work.month.title')" :bordered="false" 
        ...
        :body-style="bodyStyle">
          <template #title>
            <span class="cu-fontWeight700 cu-font14 font-color-FFFFFF"> {{$t('menu.repair.statistics.work.month.title')}} </span>
          </template>
          <div class="content-wrap">
            <div class="content">
              <a-space direction="vertical" fill>
      ...
      <a-grid-item :span="{ xs: 12, sm: 12, md: 12, lg: 8, xl: 8, xxl: 8 }">
        <a-card :title="$t('menu.repair.statistics.work.year.title')" :bordered="false"
         ...
         :body-style="bodyStyle">
          <template #title>
            <span class="cu-fontWeight700 cu-font14 font-color-FFFFFF"> {{$t('menu.repair.statistics.work.year.title')}} </span>
          </template>
          <div class="content-wrap">
            <div class="content">
              <a-space direction="vertical" fill>
...
<script lang="ts" setup>
  ...
  const eleWorkStat =  async (params) => {
    params.workType = 2
    const { data } = await getEleWorkStat(Object.assign(props.parentParams,params));
